...
declare const DEFAULT_FOLLOW_UP_TTL_MS: number;
/**
 ...
 */
export declare function saveFollowUpContext(responseId: string, context: ImageGenerationContext, ttlMs?: number): void;
/**
 * Retrieves a cached follow-up context if it has not expired yet. Expired
 * entries are removed and `null` is returned.
 */
export declare function readFollowUpContext(responseId: string): ImageGenerationContext | null;
/**
 ...
 */
export declare function evictFollowUpContext(responseId: string): void;
