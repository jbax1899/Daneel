...
export class RealtimeEventHandler extends EventEmitter {
    ...
    setupInternalEventHandlers() {
        // Handle AI responses
        this.on('response.text.delta', (event) => {
        ...
        this.on('response.completed', (event) => {
...
//# sourceMappingURL=RealtimeEventHandler.js.map