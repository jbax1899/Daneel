...
export class RateLimiter {
     ...
     */
    check(userId, channelId, guildId) {
        const now = Date.now();
     ...
     * @private
     */
    getScopeId(userId, channelId, guildId) {
 ...
 */
export function createUserRateLimiter(limit, window) {
 ...
 */
export function createChannelRateLimiter(limit, window) {
    return new RateLimiter({
        limit,
        window,
        scope: 'channel',
 ...
 */
export function createGuildRateLimiter(limit, window) {
    return new RateLimiter({
        limit,
        window,
        scope: 'guild',
