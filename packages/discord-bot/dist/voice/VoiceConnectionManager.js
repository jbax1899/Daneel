...
export class VoiceConnectionManager {
     ...
     */
    async cleanupExistingConnections(client) {
        try {
            if (!client.isReady?.()) {
     ...
     */
    async cleanupVoiceConnection(connection, client) {
        if (!connection) {
        ...
        try {
            ...
            try {
                const connectionAny = connection;
...
//# sourceMappingURL=VoiceConnectionManager.js.map