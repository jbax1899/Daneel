...
import { DEFAULT_IMAGE_GENERATION_MODEL, DEFAULT_IMAGE_GENERATION_QUALITY, ImageGenerationResolutionType } from '../utils/openaiService.js';
...
const imageCommand: Command = {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        let aspect_ratio: ImageGenerationResolutionType = 'auto'; // By default, use auto to let OpenAI determine the aspect ratio
